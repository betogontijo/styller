...
local gain = {
gainArmor='&p+10',loseArmor='&p-1',
gainShield='&s+10',loseShield='&s-(#+1)',
gainAttack='&a+10',loseAttack='&a-1',
gainDefense='&d+10',loseDefense='&d-(#+1)',
chance='100/((#*(1/(@/1)))*(@/1))',  -- Eu fiz essa equação para variar de +0 a +7 o item
