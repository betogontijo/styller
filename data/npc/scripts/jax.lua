...
local items = {
          item1 = {2472, 8931}, -- item1 item que será pedido e que será dado na primeira troca
          item2 = {6500, 8925} -- item2 item que será pedido e que será dado na segunda troca
}
local counts = {
          count1 = {40, 1}, -- count1 quantidade que será pedido e que será dado na primeira troca
          count2 = {1000, 1} -- count2 quantidade que será pedido e que será dado na segunda troca
}
