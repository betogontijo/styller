...
local config = {
    ...
    position = {
        player = Position(129, 57, 5),  -- Posição que o player deve estar
        money = Position(128, 58, 5),   -- Posição do dinheiro
        dice = Position(127, 58, 5)     -- Posição de onde estará o dado
    },
    effects = {
...
local function creatureSayCallback(cid, type, msg)
    ...
    if player then 
        npcHandler:say((status and "VOCE GANHOU!" or "VOCE PERDEU!"), cid)
    end
...
npcHandler:setMessage(MESSAGE_GREET, 'Ola |PLAYERNAME|, voce quer apostar no cassino?jogue o dinheiro no meio do depot.Diga L para 1-3, H para 4-6. Min 5k Max 1kk')
